...
import com.database.ManageMessage;
...
public class messageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            // now it's time to insert message in database within new table called message_table...
            ManageMessage.insertMessage(chatId, user_message);
            
            response.sendRedirect("CreateChatboard?Id="+Id);
            out.println("</body>");
            out.println("</html>");
        }
    }
